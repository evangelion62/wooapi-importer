...
<a href="?controler=csv&action=upload"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Ajouter un nouveau fichier csv</a>
 ...
 <table class="table table-bordered" style="background-color: white;">
  ...
  <tr>
    <td> <?php echo $csv->id()?> <a href="?controler=csv&action=del&id=<?php echo $csv->id()?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Suprimer</a> <a href="?controler=api&action=verify&id=<?php echo $csv->id()?>"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> Verifier</a></td>
